...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the TOMICS lane-matrix comparison architecture.")
    parser.add_argument("--config", required=True, help="Path to lane-matrix YAML config.")
