...
def test_tomics_grow_import_surface_exposes_model_name() -> None:
    assert MODEL_NAME == "TOMICS-Grow"


def test_tomics_grow_contracts_store_values() -> None:
...
def test_tomics_grow_contracts_are_frozen_dataclasses() -> None:
    pools = OrganCarbonPools(
        c_leaf=1.0,
        c_stem=2.0,
        c_root=3.0,
