...
from stomatal_optimiaztion.domains.tomato.tomics.alloc import MODEL_NAME
...
def test_tomics_alloc_import_surface_exposes_model_name() -> None:
    assert MODEL_NAME == "TOMICS-Alloc"
