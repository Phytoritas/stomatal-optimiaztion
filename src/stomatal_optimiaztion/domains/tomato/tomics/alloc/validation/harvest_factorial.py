...
def run_harvest_family_factorial(
    ...
    *,
    ...
    selected_payload = {
        ...
        "winner_native_state_fraction": selected.get("mean_native_family_state_fraction", 0.0),
        "winner_proxy_state_fraction": selected.get("mean_proxy_family_state_fraction", 0.0),
        "winner_shared_tdvs_proxy_fraction": selected.get("mean_shared_tdvs_proxy_fraction", 0.0),
        "family_state_mode_distribution": selected.get("family_state_mode_distribution", "{}"),
        "proxy_mode_used_distribution": selected.get("proxy_mode_used_distribution", "{}"),
