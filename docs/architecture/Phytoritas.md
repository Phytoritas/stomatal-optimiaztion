...
8. use issue `#255` artifacts under `out/tomics_knu_harvest_runtime_probe/`, `out/tomics_knu_harvest_family_factorial/`, and `out/tomics_knu_harvest_promotion_gate/` as the runtime-complete harvest-aware rerun baseline when harvest-family effects must be separated from allocator-family effects
