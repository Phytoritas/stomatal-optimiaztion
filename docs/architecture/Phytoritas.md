...
7. use issue `#239` / module `118` artifacts under `out/tomics_knu_observation_eval/`, `out/tomics_knu_state_reconstruction/`, `out/tomics_knu_rootzone_reconstruction/`, `out/tomics_knu_calibration/`, and `out/tomics_knu_promotion_gate/` as the current fair-validation promotion baseline for any later shipped-default proposal
