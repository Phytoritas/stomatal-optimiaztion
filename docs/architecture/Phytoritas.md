...
8. use issue `#243` / module `119` artifacts under `out/tomics_knu_harvest_family_factorial/` and `out/tomics_knu_harvest_promotion_gate/` when harvest-family effects must be separated from allocator-family effects
