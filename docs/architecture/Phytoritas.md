...
- Current phase: slice 079 opened the first coupled root GOSM runtime kernel and left the next biochemical kernel as the next gap
...
2. continue from the bounded GOSM runtime helpers into the next biochemical runtime seam at `GOSM/src/gosm/model/carbon_assimilation.py`
